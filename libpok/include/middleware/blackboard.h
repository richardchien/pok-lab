...
pok_ret_t pok_blackboard_create(char* name, const pok_size_t msg_size, pok_blackboard_id_t* id);

pok_ret_t pok_blackboard_read(const pok_blackboard_id_t id, const uint64_t timeout, void* data, pok_port_size_t* len);
