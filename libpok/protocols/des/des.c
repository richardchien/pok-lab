...
void pok_protocols_des_marshall(void* uncrypted_data, pok_size_t uncrypted_size, void* crypted_data,
                                size_t* crypted_size) {
    DES_cblock ivec;
...
void pok_protocols_des_unmarshall(void* crypted_data, pok_size_t crypted_size, void* uncrypted_data,
