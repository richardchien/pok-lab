 ...
 */
void pok_protocols_ceasar_marshall(void* uncrypted_data, pok_size_t uncrypted_size, void* crypted_data,
                                   size_t* crypted_size) {
    uint8_t* uncrypted;
    uint8_t* crypted;
    size_t tmp;
 ...
 *\\brief Unmarshall data, the crypted size has
          the same size than uncrypted data.
 */
void pok_protocols_ceasar_unmarshall(void* crypted_data, pok_size_t crypted_size, void* uncrypted_data,
