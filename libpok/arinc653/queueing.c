...
void CREATE_QUEUING_PORT(
    ...
    core_ret = pok_port_queueing_create(
        QUEUING_PORT_NAME, MAX_MESSAGE_SIZE * MAX_NB_MESSAGE, core_direction, core_discipline, &core_id);
...
void RECEIVE_QUEUING_MESSAGE(
    ...
    core_ret =
        pok_port_queueing_receive(QUEUING_PORT_ID, pok_timeout, *LENGTH, MESSAGE_ADDR, (pok_port_size_t *)LENGTH);
