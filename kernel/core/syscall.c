...
pok_ret_t pok_core_syscall(const pok_syscall_id_t syscall_id, const pok_syscall_args_t* args,
    ...
    case POK_SYSCALL_MIDDLEWARE_VIRTUAL_CREATE:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, pok_ports_names_max_len + 1);

        pok_check_ptr_or_return(infos->partition, (void*)args->arg2, sizeof(pok_port_id_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_VIRTUAL_NB_DESTINATIONS:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg2, sizeof(uint32_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_VIRTUAL_DESTINATION:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg3, sizeof(uint32_t));

        return pok_port_virtual_destination(
            (pok_port_id_t)(args->arg1), (uint32_t)(args->arg2), (uint32_t*)(args->arg3 + infos->base_addr));
        break;
    ...
    case POK_SYSCALL_GETTICK:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(uint64_t));
    ...
    case POK_SYSCALL_THREAD_CREATE:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(uint32_t));

        pok_check_ptr_or_return(infos->partition, (void*)args->arg2, sizeof(pok_thread_attr_t));
    ...
    case POK_SYSCALL_PARTITION_GET_ID:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(uint8_t));
    ...
    case POK_SYSCALL_PARTITION_GET_OPERATING_MODE:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(pok_partition_mode_t));
    ...
    case POK_SYSCALL_PARTITION_GET_START_CONDITION:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(pok_start_condition_t));
    ...
    case POK_SYSCALL_ERROR_GET:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(pok_error_status_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_SAMPLING_CREATE:
        ...
        pok_check_ptr_or_return(infos->partition, (void*)args->arg5, sizeof(pok_port_id_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_SAMPLING_READ:
        ...
        pok_check_ptr_or_return(infos->partition, (void*)args->arg3, sizeof(pok_port_size_t));

        pok_check_ptr_or_return(infos->partition, (void*)args->arg4, sizeof(bool_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_SAMPLING_STATUS:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg2, sizeof(pok_port_sampling_status_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_QUEUEING_RECEIVE:
        ...
        pok_check_ptr_or_return(infos->partition, (void*)args->arg5, sizeof(pok_port_size_t));
    ...
    case POK_SYSCALL_MIDDLEWARE_QUEUEING_STATUS:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg2, sizeof(pok_port_queueing_status_t));
    ...
    case POK_SYSCALL_LOCKOBJ_CREATE:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(pok_lockobj_id_t));

        pok_check_ptr_or_return(infos->partition, (void*)args->arg2, sizeof(pok_lockobj_attr_t));
    ...
    case POK_SYSCALL_PCI_REGISTER:
        pok_check_ptr_or_return(infos->partition, (void*)args->arg1, sizeof(s_pci_device));
...
// Bellow, POK_NEEDS_PCI is kept for backward compatibility with code generators
    ...
    case POK_SYSCALL_RTL8929_READ:
        ...
        rtl8029_read((pok_port_id_t)(args->arg1), (uint32_t*)(args->arg2 + infos->base_addr), (uint32_t)(args->arg3));
    ...
    case POK_SYSCALL_RTL8929_POLL_AND_READ:
        ...
        rtl8029_poll_and_read(
            (pok_port_id_t)(args->arg1), (uint32_t*)(args->arg2 + infos->base_addr), (uint32_t)(args->arg3));
    ...
    case POK_SYSCALL_RTL8929_WRITE:
        ...
        rtl8029_write((pok_port_id_t)(args->arg1), (uint32_t*)(args->arg2 + infos->base_addr), (uint32_t)(args->arg3));
        break;
