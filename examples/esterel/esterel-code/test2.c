 ...
 *                               POK header
 * 
 * The following file is a part of the POK project. Any modification
 * should
 * made according to the POK licence. You CANNOT use this file or a part of
 * this file is this part of a
 * file for your own project
 *
 * For more information on the POK licence, please see our LICENCE FILE
 *
 * Please
 * follow the coding guidelines described in doc/CODING_GUIDELINES
 *
 *                                      Copyright
 * (c) 2007-2009 POK team 
 *
...
#define _input_status_reset_and_pre_update _input_signal_V0 = (_input_signal_V0 << 1) & 0x0u;
/* Output signal macros */
#define _output_status_reset_and_pre_update _output_signal_V0 = (_output_signal_V0 << 1) & 0x0u;
