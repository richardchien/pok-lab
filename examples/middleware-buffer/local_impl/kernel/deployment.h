...
typedef enum { ports_global_pr1_dataout = 0, ports_global_pr2_datain = 1 } pok_parts_ports_global_identifiers_t;

typedef enum { port_all_pr1_dataout = 0, port_all_pr2_datain = 1 } pok_parts_ports_all_identitiers_t;
